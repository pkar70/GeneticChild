...
#End Region
    ...
    Public Shared glItems As New ListaOsob(Windows.Storage.ApplicationData.Current.RoamingFolder.Path)

    Public Shared Function GetCechaName(iCecha As Integer, Optional bDom As Boolean = True) As String
        Dim sName As String = "cecha" & iCecha.ToString("00")
        If bDom Then
            sName &= "dom"
        Else
            sName &= "rec"
        End If
        Return GetLangString(sName, "ERR")
    End Function
End Class
